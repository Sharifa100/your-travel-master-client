                    ...
                    <div className="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                        ...
                        <div className="card">
                            ...
                            <form className="form-card" onsubmit="event.preventDefault()">
                                ...
                                <div className="row justify-content-between text-left">
                                    <div className="form-group col-12 flex-column d-flex"> <label className="form-control-label px-3">Write Your Health Condition<span className="text-danger"> *</span></label> <input type="text" id="ans" name="ans" placeholder="" onblur="validate(6)" /> </div>
                                </div>
